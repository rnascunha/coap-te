...
template<std::size_t BufferSize>
void Factory<BufferSize>::payload(void const* pd, std::size_t payload_len) noexcept
{
	payload_ = pd;
...
template<std::size_t BufferSize>
void Factory<BufferSize>::payload(const char* pd) noexcept
{
	payload_ = pd;
...
template<std::size_t BufferSize>
void Factory<BufferSize>::reset() noexcept
{
...
template<std::size_t BufferSize>
typename Factory<BufferSize>::buffer_type const*
Factory<BufferSize>::buffer() const noexcept
{
