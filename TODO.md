...
* Buffer iterator has a specialization to mutable_buffer and const_buffer. This makes reduce the class size and the processing needed;  // No... need to implement
