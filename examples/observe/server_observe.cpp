...
using observe_list = CoAP::Observe::list_vector<CoAP::Observe::observe<endpoint>>;
#else
/**
...
using observe_list = CoAP::Observe::list<
						CoAP::Observe::observe<endpoint>,	//Observer type
						5									//Observer number
					>;
#endif
...
class Sensor_Observe{
	public:
		using endpoint_t = CoAP::Observe::observe<endpoint>::endpoint_t;
		Sensor_Observe(){};
		 ...
		 */
		CoAP::Observe::observe<endpoint> const& observe() const noexcept
		{ return obs_; }
	...
	private:
		CoAP::Observe::observe<endpoint> obs_;
		unsigned 		freq_ = 30;
		CoAP::time_t	init_time_;
};
/**
