#ifndef COAP_TE_PORT_POSIX_ENDPOINT_IP_HPP__
#define COAP_TE_PORT_POSIX_ENDPOINT_IP_HPP__
...
class endpoint_ip{
	public:
		...
		endpoint_ip(const char* addr_str, std::uint16_t port, CoAP::Error& ec)
		{
...
#endif /* COAP_TE_PORT_POSIX_ENDPOINT_IP_HPP__ */
